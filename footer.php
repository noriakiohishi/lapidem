		...
		<div class="footer_nav">
			...
			<nav class="footer_nav_bottom">
				<ul>
					...
					<li><a href="/news/2020-summer-vacation/"><span class="en">News</span><span class="ja">新着情報</span></a></li>
					<li><a href="/awards/"><span class="en">Award</span><span class="ja">受賞歴</span></a></li>
				</ul>
			</nav>
		</div>
	</div>
	<div class="copy">&copy; 2020 Lapidem tokyo.<br class="disp_sp">All rights reserved.</div>
</footer>
...
//アコーディオン
	...
	$("div[id*=trigger]").click(function(){
		...
		var changeID = myID.replace('trigger' , 'detail');		
		$("#"+changeID).slideToggle();
        $(this).toggleClass("show_close-btn");
	});
...
//FAQアコーディオン
    $(".faq .faq_body .faq_body_in dd").hide();
    $(".faq .faq_body .faq_body_in dt").click(function(){
