...
/*180802 mw wp form validate いずれか必須状態　Artist program用 生年月日フィールド */
...
add_filter( 'mwform_validation_mw-wp-form-58', 'entry_validation_rule', 10, 2 ); /* [mwform_formkey key="58"] */
